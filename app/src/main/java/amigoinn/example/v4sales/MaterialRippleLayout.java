...
public class MaterialRippleLayout extends FrameLayout {
    ...
    public MaterialRippleLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        rippleColor1 = a.getColor(R.styleable.MaterialRippleLayout_rippleColor1, DEFAULT_COLOR);
    ...
    * Accessor
     */
    public void setRippleColor1(int rippleColor1) {
        this.rippleColor1 = rippleColor1;
        paint.setColor(rippleColor1);
        paint.setAlpha(rippleAlpha);
        invalidate();
    }
    ...
    public static class RippleBuilder {
        ...
        private int     rippleColor1         = DEFAULT_COLOR;
        ...
        public RippleBuilder rippleColor1(int color) {
            this.rippleColor1 = color;
            return this;
        }
        ...
        public MaterialRippleLayout create() {
            ...
            layout.setRippleColor1(rippleColor1);
